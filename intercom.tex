...
\begin{figure}[ht!]
	\centering
	\subfloat[Attractive Force]{\includegraphics[width=40mm]{attr_force.png}}
...
\begin{figure}
	\centering
	\subfloat[Attractive force applied to the mobile robot]{\includegraphics[width = 70mm]{attr_kbki.png}}\\
	\subfloat[Repulsive force applied to the mobile robot] {\includegraphics[width = 70mm]{rep_kbki.png}}\\
	\subfloat[Navigation force applied to the mobile robot]{\includegraphics[width = 70mm]{nav_kbki.png}}
...
\begin{figure}
	\centering
	\subfloat[Attractive force applied kobuki with lidar]{\includegraphics[width = 70mm]{fattr_lidar.png}}\\
	\subfloat[Attractive force applied kobuki with lidar]{\includegraphics[width = 70mm]{frep_lidar.png}}\\
	\subfloat[Attractive force applied kobuki with lidar]{\includegraphics[width = 70mm]{fnav_lidar.png}}\\
