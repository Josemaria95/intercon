...
\begin{figure}
  \centering
  % \subfloat [Kobuki with lidar in workspace]{\includegraphics[width = 70mm]{kobuki_201.jpg}}\\
  \subfloat[Online attractive force applied to the robot]{\includegraphics[width = 70mm]{images/fattr_lidar.png}}\\
  \subfloat[Online repulsive force applied to the robot]{\includegraphics[width = 70mm]{images/frep_lidar.png}}\\
  \subfloat[Online resulting force]{\includegraphics[width = 70mm]{images/fnav_lidar.png}}\\
  \captionsetup{font=footnotesize}
