...
\begin{figure}%[ht!]
  \centering \footnotesize
  \subfloat[Attractive Force]{\includegraphics[width=0.16\textwidth]{attr_force2.png}}
  ~\subfloat[Repulsive Force]{\includegraphics[width=0.16\textwidth]{rep_force.png}} ~
  \subfloat[Navigation Force]{\includegraphics[width=0.16\textwidth]{nav_force.png}}
  % \subfloat[Attractive Force]{\includegraphics[width = 150mm]{attr_force.png}}
  \captionsetup{font=footnotesize}
...
\begin{figure}
  \centering
  \subfloat[Position (x) evolution]{\includegraphics[width = 40mm]{tvsxy_tesis.png}}
  ~\subfloat[Linear velocity evolution]{\includegraphics[width = 40mm]{tvsv_tesis.png}}\\
  \subfloat[Orientation evolution]{\includegraphics[width = 40mm]{tvstheta_tesis.png}}
  ~\subfloat[Angular velocity evolution]{\includegraphics[width =
...
\begin{figure}
  \centering
  \subfloat[Attractive force applied to the mobile robot]{\includegraphics[width = 60mm]{attr_kbki.png}}\\
  \subfloat[Repulsive force applied to the mobile robot] {\includegraphics[width = 60mm]{rep_kbki.png}}\\
  \subfloat[Navigation force applied to the mobile robot]{\includegraphics[width = 60mm]{nav_kbki.png}}
  \captionsetup{font=footnotesize}
  \caption{Autonomous navigation implemented on Kobuki} \label{f:kbki}
\end{figure}
...
\begin{figure}
  \centering
  % \subfloat [Kobuki with lidar in workspace]{\includegraphics[width = 70mm]{kobuki_201.jpg}}\\
  \subfloat[Online attractive force applied to the robot]{\includegraphics[width = 70mm]{fattr_lidar.png}}\\
  \subfloat[Online repulsive force applied to the robot]{\includegraphics[width = 70mm]{frep_lidar.png}}\\
  \subfloat[Online resulting force]{\includegraphics[width = 70mm]{fnav_lidar.png}}\\
  \captionsetup{font=footnotesize}
